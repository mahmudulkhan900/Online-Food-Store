			...
			<div class="col s12 m4">
				<div class="card">
				    ...
				    <div class="card-content">
				      <span class="card-title activator grey-text text-darken-4"><a class="black-text" href="foods.php?id=<?php echo $arr_all[$i+$j-2]['id']; ?>"><?php echo $arr_all[$i+$j-2]['c_name']; ?></a><i class="material-icons right">more_vert</i></span>
				      <div class="card-content">
			          <p>This is a popular category of Bangladesh. Explore the Foods of this category!</p>
			        </div>
				    </div>
