<div class="row">
			...
			<div class="col s2 left-sidebar" id="left-sidebar">
				...
				<div class="row">
					<div class="col">
						<h4 class="heading-name">Online Food Store</h4>
					</div>
				</div>
				<ul class="nav nav-sidebar list-group">
				    ...
				    <li class="list-group-item"><a href="user-list.php">Users</a></li>
				    <li class="list-group-item"><a href="man-list.php">Delivary Man</a></li>
